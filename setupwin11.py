...
def required_packages():
    ...
    os.system("wget -P /data/data/com.termux/files/usr/win11arm/ https://mega.nz/file/uJdghAoC#GmoVr4B-BDx4EISlawZmGXShxuqQfG3y0Ayl8Z_4KSE ; cd Windows-11-ARM ; mv win11armmainmenu.py /data/data/com.termux/files/usr/win11arm/")
